...
static LATEST: LazyLock<Mutex<Vec<ProcessSnapshot>>> = LazyLock::new(|| Mutex::new(Vec::new()));

/// Recent threats detected by the monitor.
static RECENT_THREATS: LazyLock<Mutex<Vec<Threat>>> = LazyLock::new(|| Mutex::new(Vec::new()));
